...
SyntaxError: Unexpected token '<', "<?xml vers"... is not valid JSON {stack: `SyntaxError: Unexpected token '<', "<?xml vers"... is not valid JSON`, message: `Unexpected token '<', "<?xml vers"... is not valid JSON`}
